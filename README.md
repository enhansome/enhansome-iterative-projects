...
* [zincware/dask4dvc](https://github.com/zincware/dask4dvc) ⚠️ Archived: Provides a DVC-like CLI that combines DVC with [Dask Distributed](https://distributed.dask.org/) to make it easier to use with HPC managers like [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,278 | 🐛 14 | 🌐 C | 📅 2026-08-24
* [COVID Genomics/Airflow-DVC](https://github.com/covid-genomics/airflow-dvc) ⚠️ Archived: Airflow extension for DVC.
* [COVID Genomics/dvc-fs](https://github.com/covid-genomics/dvc-fs) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2022-09-27: High-level abstraction for DVC file manipulation (listing & I/O) with basic support for [PyFilesystem2](https://github.com/PyFilesystem/pyfilesystem2) ⭐ 2,107 | 🐛 117 | 🌐 Python | 📅 2025-05-17.
