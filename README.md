...
# Awesome Iterative Projects with stars

[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

A list of projects relying on [Iterative](https://github.com/iterative) tools to achieve awesomeness.

Missing something awesome? Anyone is welcome to [submit projects to this list](https://github.com/iterative/awesome-iterative-projects/blob/main/contributing.md) ⭐ 70 | 🐛 2 | 📅 2024-07-11.

## Tools & Libraries

* [zincware/ZnTrack](https://github.com/zincware/ZnTrack) ⭐ 57 | 🐛 131 | 🌐 Python | 📅 2026-08-24: Create, visualize, run & benchmark DVC pipelines in Python & Jupyter notebooks.
...
* [zincware/dask4dvc](https://github.com/zincware/dask4dvc) ⚠️ Archived: Provides a DVC-like CLI that combines DVC with [Dask Distributed](https://distributed.dask.org/) to make it easier to use with HPC managers like [Slurm](https://github.com/SchedMD/slurm) ⭐ 4,280 | 🐛 14 | 🌐 C | 📅 2026-08-25
* [COVID Genomics/Airflow-DVC](https://github.com/covid-genomics/airflow-dvc) ⚠️ Archived: Airflow extension for DVC.
* [COVID Genomics/dvc-fs](https://github.com/covid-genomics/dvc-fs) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2022-09-27: High-level abstraction for DVC file manipulation (listing & I/O) with basic support for [PyFilesystem2](https://github.com/PyFilesystem/pyfilesystem2) ⭐ 2,106 | 🐛 117 | 🌐 Python | 📅 2025-05-17.

## Tutorials

* [DVC Streamlit Example](https://github.com/sicara/dvc-streamlit-example) ⭐ 40 | 🐛 1 | 🌐 HTML | 📅 2023-10-27: Build a custom web UI with DVC and Streamlit for visually tracking & comparing model performance during R\&D (adapted from [TensorFlow's transfer learning tutorial](https://www.tensorflow.org/tutorials/images/transfer_learning)).
* [CD4ML Example](https://github.com/sbalnojan/cd4ml-example) ⭐ 24 | 🐛 4 | 🌐 Python | 📅 2022-12-08: Example DVC setup with AWS S3 remote storage & GitLab CI/CD.
* [DVC Pipelines and Experiments Tutorial](https://github.com/dmesquita/dvc_pipelines_and_experiments_tutorial) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2020-07-07: Build maintainable Machine Learning pipelines using DVC.
* [DVC with PyCaret & FastAPI](https://github.com/tezansahu/dvc-pycaret-fastapi-demo) ⭐ 11 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-01-20: End-to-end demo of data & model tracking (DVC), remote storage (Azure), efficient experimentation (PyCaret) & model deployment (FastAPI).
